 ...
 * Wolfgang Hoschek. For other information about COLT see <a
 * href="http://acs.lbl.gov/software/colt/">its home page</a>.
 * </p>
...
//				score = Math.exp(-(score * score) / (2 * sigma_sq));
	...
	protected void setData(GHGraphBuilder data) {
		this.data = data;
	}

	protected GHGraphBuilder getData() {
		return data;
	}
